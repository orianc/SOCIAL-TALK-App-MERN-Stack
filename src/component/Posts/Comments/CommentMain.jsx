...
const Comment = () => {
	return (
		<div className="text-right w-50">
			<textarea className="form-control my-1" placeholder="Comment..." name="commentContent" cols="10" rows="1"></textarea>
			<button className="btn btn-primary btn-sm">
				Comment
				<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="16" height="16" className="ml-2 bi bi-chat-text-fill" viewBox="0 0 16 16">
